#aosucas499/guadalinex:precise
# basado en ubuntu 12 precise 64bit
...
FROM i386/ubuntu:precise-20160108
...
RUN apt-get update && apt-get install libnotify-bin dbus dbus-x11 libusb-1.0 python -y && apt-get clean
